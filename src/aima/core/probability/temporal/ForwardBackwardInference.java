 ...
 * 
 */
public interface ForwardBackwardInference extends ForwardStepInference, BackwardStepInference
{
	 ...
	 */
	List<CategoricalDistribution> forwardBackward(List<List<AssignmentProposition>> ev, CategoricalDistribution prior);
}
