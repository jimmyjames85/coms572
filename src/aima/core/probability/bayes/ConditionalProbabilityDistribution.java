...
public interface ConditionalProbabilityDistribution {
	 ...
	 * @see ConditionalProbabilityDistribution#getParents()
	 */
	ProbabilityDistribution getConditioningCase(AssignmentProposition... parentValues);
	 ...
	 * @see ConditionalProbabilityDistribution#getOn()
	 */
	Object getSample(double probabilityChoice, AssignmentProposition... parentValues);
}
