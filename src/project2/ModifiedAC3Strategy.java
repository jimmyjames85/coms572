...
/**
 * Artificial Intelligence A Modern Approach (3rd Ed.): Figure 6.3, Page 209.<br> <br>
 *
 * <pre>
 * <code>
 ...
 * </pre>
 *
 * Figure 6.3 The arc-consistency algorithm AC-3. After applying AC-3, either every arc is arc-consistent, or some
 * variable has an empty domain, indicating that the CSP cannot be solved. The name "AC-3" was used by the algorithm's
 * inventor (Mackworth, 1977) because it's the third version developed in the paper.
 *
 ...
 */
public class ModifiedAC3Strategy
{
	 ...
	 *         undo the operation.
	 */
	public DomainRestoreInfo reduceDomains(CSP csp, DomainRestoreInfo currentInfo)
	{
		DomainRestoreInfo result = currentInfo;  // <---------------------------------MODIFICATION here
	...
	private void reduceDomains(FIFOQueue<Variable> queue, CSP csp, DomainRestoreInfo info)
	{
		while (!queue.isEmpty())
		{
