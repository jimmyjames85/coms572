...
/**
 * Cooperates with a {@link CSPEnvironment} and visualizes its state. The viewer shows the structure of the CSP network,
 * the current state of all domains, and the current assignment.
 *
 ...
 */
public class ModifiedCSPView extends CSPView
{
	...
	protected void drawVariable(Graphics2D g2, Variable var)
	{
		...
		g2.fillOval(pos[0] + 15, pos[1] + 15, 10, 10);
		g2.setColor(Color.BLACK);
		g2.drawOval(pos[0] + 15, pos[1] + 15, 10, 10);
		g2.drawString(label, pos[0] + 15, pos[1] + 15);
		g2.drawString(getCSP().getDomain(var).toString(), pos[0] + 15, pos[1] + 15 + 52);
	}
